...
- [x] **6.1 实现 ScreenshotViewModel**
  - 创建 ScreenshotViewModel 类
  - 实现截图意图处理
  - 实现截图状态管理
  - 实现 UI 状态更新

- [x] **6.2 实现 SettingsViewModel**
...
- [x] **7.1 实现重叠检测算法**
  - 创建 OverlapDetector 类
  - 实现模板匹配算法（TemplateMatcher）
  - 实现特征点检测算法（FeatureDetector）
  - 实现SSIM结构相似度计算
  - 测试重叠检测准确率
...
- [x] **8.1 实现 LongScreenshotProcessor**
  - 创建 LongScreenshotProcessor 类
  - 实现三种模式的协调逻辑
  - 实现拼接状态管理
  - 实现进度更新机制
  - 实现异常处理
